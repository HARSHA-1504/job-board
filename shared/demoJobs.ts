import type { Job, JobProvider, JobSearchParams } from "./nexora";
...
const EXPANDED_DEMO_JOBS: Job[] = [
  ...
  },
  {
    ...
    currency: "INR",
    description:
      "Build reliable Android product features in Kotlin for a consumer lifestyle app. You will work with REST APIs, Play Store releases, and a design team that cares about polish.",
    skills: ["Kotlin", "Android", "REST APIs", "Git", "Mobile Testing"],
    postedAt: "2026-07-24T08:15:00.000Z",
    source: "NEXORA demo network",
    applyUrl: "https://example.com/careers/helio-android",
  },
];
...
export const DEMO_JOBS: Job[] = [
  {
    ...
    currency: "INR",
    description:
      "Own ML model deployment, monitoring, and data pipelines. Work closely with research and engineering to productionize models safely.",
    skills: ["Python", "Kubernetes", "MLflow", "Docker", "AWS"],
    postedAt: "2026-08-20T05:00:00.000Z",
    source: "NEXORA demo network",
    applyUrl: "https://example.com/careers/sunrise-mlops",
  },
  {
    id: "nx-zen-ux",
    ...
    currency: "INR",
    description:
      "Lead UX for a consumer product, mentor designers, and shape research-driven product decisions.",
    skills: ["Figma", "User Research", "Prototyping", "Design Systems", "Mentorship"],
    postedAt: "2026-08-20T06:30:00.000Z",
    source: "NEXORA demo network",
    applyUrl: "https://example.com/careers/zen-ux",
  },
  {
    id: "nx-aurora-python",
